...
connect = mysql.connector.connect(
        ...
        user="root",
        password="moni",
        database="phone_pe",  # Use the newly created database
        port=3306
    )
...
def Aggre_insurance_Y(df, year):
    ...
    cols1, cols2 = st.columns(2)  # Use meaningful variable names like 'cols1' and 'cols2' to represent the column layout
    with cols1:
    ...
    cols3, cols4 = st.columns(2)  # Use separate variables for the next set of columns
    with cols3:
...
if select == "Home":
    ...
    with col2:
        st.video("C:\\Users\\admin\\Desktop\\Phone Pe Ad.mp4")
